Para finalizar la clase de hoy vamos a darle un poco de color a nuestra página web.
...
> El `<h2>` debe tener un fondo de color Negro y la tipografía de color #00FFFF y la caja completa (fondo y color) deben tener una opacidad de 0.8
